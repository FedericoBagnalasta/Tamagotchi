...
public class Main {
	...
	private static Tamagotchi creaTamagotchi() {
		...
		int gradoAffettivo=InputDati.leggiIntero(RICHIESTA_SODDISFAZIONE, MIN_SODDISFAZIONE_INIZIALE, MAX_SODDISFAZIONE_INIZIALE);
		int gradoSazieta=InputDati.leggiIntero(RICHIESTA_SAZIETA, MIN_SAZIETA_INIZIALE, MAX_SAZIETA_INIZIALE);
		
		Tamagotchi tamagotchi=new Tamagotchi(nome, gradoAffettivo, gradoSazieta);
		return tamagotchi;
	}
